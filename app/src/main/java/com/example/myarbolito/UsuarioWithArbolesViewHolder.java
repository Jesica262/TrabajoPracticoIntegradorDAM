...
public class UsuarioWithArbolesViewHolder extends RecyclerView.Adapter<UsuarioWithArbolesViewHolder.ViewHolder> implements View.OnClickListener  {
    ...
    @Override
    public UsuarioWithArbolesViewHolder.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.element, parent, false);
        view.setOnClickListener(this);
        return new UsuarioWithArbolesViewHolder.ViewHolder(view);
    }
